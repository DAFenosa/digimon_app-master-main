...
class _MyHomePageState extends State<MyHomePage> {
  List<Digimon> initialDigimons = []..add(Digimon('Leo Messi'))..add(Digimon('Ansu Fati'))..add(Digimon('Luke de tronc'))..add(Digimon('Memphis Depay'))..add(Digimon('Pablo Gavi'));
